...
export default function LogoMarquee() {
  return (
    <section className="w-full bg-[#f6f8f3] py-12 overflow-hidden">
      <div className="relative">
        {/* Gradient fade edges */}
        <div className="pointer-events-none absolute left-0 top-0 h-full w-24 bg-gradient-to-r from-[#f6f8f3] to-transparent z-10" />
        <div className="pointer-events-none absolute right-0 top-0 h-full w-24 bg-gradient-to-l from-[#f6f8f3] to-transparent z-10" />
